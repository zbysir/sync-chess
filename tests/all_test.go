...
func TestPlayPengHu(t *testing.T) {
	...
	p1.WriteAction(&core.PlayerAction{
		ActionType: core.AT_Play,
		Card:       100,
	})
	// 模拟玩家3可胡
	...
	time.Sleep(1 * time.Millisecond)
	// 这时候玩家2先点击碰
	p2.WriteAction(&core.PlayerAction{
		ActionType: core.AT_Peng,
		Card:       100,
	})
	...
	case 1:
		// 玩家3点击胡
		// 期望结果是 玩家3胡了 游戏结束
		p3.WriteAction(&core.PlayerAction{
			ActionType: core.AT_Hu,
			Card:       100,
		})
	case 2:
		// 另: 玩家3点pass
